...
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onRequestPermissionsResult(): " + e);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onCreate(): " + e);
        }
    }
    ...
    public void onResume() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onResume(): " + e);
        }
    }
    ...
    public void onPause() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onPause(): " + e);
        }
    }
    ...
    public void resetData() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_resetData(): " + e);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onCreateOptionsMenu(): " + e);
        }
        return true;
    }
    ...
    public void showDetails(WifiP2pDevice device) {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_showDetails(): " + e);
        }
    }
    ...
    public void connect(WifiP2pConfig config) {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_connect(): " + e);
        }
    }
    ...
    public void disconnect() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_disconnect(): " + e);
        }
    }
    ...
    public void onChannelDisconnected() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_onChannelDisconnected(): " + e);
        }
    }
    ...
    public void cancelDisconnect() {
        try {
            ...
            Log.e("JavaInfo","Error WiFiDirectActivity_cancelDisconnect(): " + e);
        }
    }
}
